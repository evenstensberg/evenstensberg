...
export default function MainMenuComponent() {
  ...
  const handleClose = (event, name) => {
    ...
    setOpen(false);
    const sectionNode = document.getElementById(name);
    window.scrollTo({
              ...
              <Paper>
                <ClickAwayListener onClickAway={handleClose}>
                  <MenuList autoFocusItem={open} id="menu-list-grow" onKeyDown={handleListKeyDown}  className={classes.menuList}>
                    <MenuItem onClick={e => handleClose(e, 'code-section')}>Code</MenuItem>
                    <MenuItem onClick={e => handleClose(e, 'cf-section')}>CrossFit</MenuItem>
                    <MenuItem onClick={e => handleClose(e, 'art-section')}>Art</MenuItem>
                  </MenuList>
                </ClickAwayListener>
              </Paper>
            </Grow>
