...
const code_posts = [
  { title: 'GitHub Sponsors', content: github, query: '/sponsors', subtitle: 'You can sponsor my work in OSS' },
  ...
  { title: 'S19 Internship at Cognite', content: cognite, query: '/cognite', subtitle: 'A summary of my summer at Cognite' },
  { title: 'Using less time in tools', content: tools, query: '/tools', subtitle: 'Using tools the correct way to speed up development' },
  ...
  { title: 'Architectural Beams in Front End', content: arch, query: '/architecture', subtitle: 'Making good front-end layers' },
                    ...
                    <GridListTileBar
                      ...
                      actionIcon={
                        <IconButton aria-label={`info about ${post.title}`} className={classes.icon}>
                          <Link to={post.query}><LaunchIcon /></Link>
                        </IconButton>
                      }
                    />
                  </GridListTile>
